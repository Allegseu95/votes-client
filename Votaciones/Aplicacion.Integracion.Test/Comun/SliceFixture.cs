...
public class SliceFixture : IAsyncLifetime
{
    ...
    public Task<EscrutinioDbContext> Context() => ExecuteScopeAsync(sp => Task.FromResult(sp.GetService<EscrutinioDbContext>()));

    private class AplicacionFactory
        : WebApplicationFactory<Program>
    {
        private const string CONNECTION_STRING =
            "Data Source=(localDb)\\MSSQLLocalDB;Database=Escrutinio;Integrated Security=True";
